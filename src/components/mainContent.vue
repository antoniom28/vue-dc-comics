<template>
  <main>
    <div class="container">
       <mainButton class="main-button" text-button="CURRENT SERIES"/>
       <ul>
         <mainSeries v-for="(item,index) in allSeries" :key="index"
          :current-series="item"/> 
       </ul>
       <mainButton class="standard-button" text-button="LOAD MORE"/>
    </div>
  </main>
</template>
